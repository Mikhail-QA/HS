...
class AssertForTest011(AssertForTest001):
    ...
    def check_text_in_page_list_all_activities(self):
        ...
        self.assertEqual(
            u"Геометрия. Стандартный курс Геометрические фигуры. Точка, прямая, отрезок и их свойства 03.09.2018 (неделя 2)"
            ...
            u"\nАлгебра. Эффективный курс Входное тестирование 12.09.2018 (неделя 3)"
