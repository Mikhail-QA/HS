...
class AssertForTest001(unittest.TestCase):
    ...
    def check_text_in_tab_6(self):
        ...
        self.assertEqual(u"Класс: 1", self.driver.find_element_by_css_selector(SubscribeLocatorsStepSix.element_grade).text)

        self.assertEqual(u"Формат обучения: «Самостоятельный»",
                         self.driver.find_element_by_css_selector(SubscribeLocatorsStepSix.element_format_in_course).text)
        ...
        self.assertEqual(u"Сумма к оплате: 800 руб.",
                         self.driver.find_element_by_css_selector(SubscribeLocatorsStepSix.element_payment_summary_price).text)
...
class AssertForTest002(AssertForTest001):
    ...
    def check_text_in_tab_6(self):
        ...
        self.assertEqual(u"Класс: 7", self.driver.find_element_by_css_selector(SubscribeLocatorsStepSix.element_grade).text)
...
class AssertForTest003(AssertForTest001):
    ...
    def check_text_in_tab_6(self):
        ...
        self.assertEqual(u"Класс: 10", self.driver.find_element_by_css_selector(SubscribeLocatorsStepSix.element_grade).text)
...
class AssertForTest011(AssertForTest001):
    ...
    def check_text_in_page_list_all_activities(self):
        ...
        self.assertEqual(
            u"Вводный урок Вводный урок 01.09.2018 (неделя 1)"
            u"\nФизика. Стандартный курс Входное тестирование 03.09.2018 (неделя 2)"
            u"\nРусский язык Стилистика. Научный и публицистический стили. Анализ текста. Главная информация 03.09.2018 (неделя 2)"
            u"\nАлгебра. Стандартный курс Входное тестирование 03.09.2018 (неделя 2)"
            ...
            u"\nИнформатика Понятие системы 03.09.2018 (неделя 2)"
            u"\nИстория Политическое и экономическое развитие стран в начале XX века 03.09.2018 (неделя 2)"
            u"\nХимия Основные сведения о строении атома 04.09.2018 (неделя 2)"
            ...
            u"\nБиология Обзор эволюционных представлений 05.09.2018 (неделя 2)"
            u"\nФизика Взаимодействие токов. Магнитное поле. Вектор магнитной индукции. Линии магнитной индукции 06.09.2018 (неделя 2)"
            u"\nГеометрия. Эффективный курс Входное тестирование 06.09.2018 (неделя 2)"
            u"\nЛитература Введение. Историческая и культурная ситуация. Марксизм, ницшеанство, толстовство. Декаданс, модернизм, авангард. Особенности русского реализма конца XIX-начала ХХ 06.09.2018 (неделя 2)"
